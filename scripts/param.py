...
class recognizer(object):
    ...
    def final_result(self, hyp, uttid):
        ...
        if(msg.data.find("move")):
            rospy.loginfo("Recognized a move command before publishing")
            os.system("rosnode roskill /param")
            os.system ("echo trying to kill this node")
            #exit()
        os.system("echo testing system call")
